...
def build_model():
    ...
    l1a_c = Conv2DLayer(l_in, num_filters=4, filter_size=(3, 3), border_mode='same', W=nn.init.Orthogonal('relu'))
    l1b_c = Conv2DLayer(l1a_c, num_filters=8, filter_size=(3, 3), border_mode='same', W=nn.init.Orthogonal('relu'))
    l1_pool = MaxPool2DLayer(l1b_c, (2, 2), (2, 2))
    l2a_c = Conv2DLayer(l1_pool, num_filters=16, filter_size=(3, 3), border_mode='same', W=nn.init.Orthogonal('relu'))
    ...
    l6 = nn.layers.DenseLayer(nn.layers.dropout(l2_pool, p=0.5), num_units=64, W=nn.init.Orthogonal('relu'))
